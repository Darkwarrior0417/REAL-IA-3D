...
public class BossController : MonoBehaviour
{
    ...
    public string sceneToLoad = "WinScene"; // Escena a cargar cuando muera el jefe
    ...
    public void TakeDamage(float damage)
    {
        ...
        Debug.Log("El jefe ha recibido " + damage + " de daño. Salud actual: " + currentHealth); // Confirmación de daño
    ...
    private void Attack()
    {
        ...
        if (distanceToPlayer <= attackRange)
        {
            ...
            Debug.Log("El jefe ha atacado al jugador con " + attackDamage + " de daño.");
        }
    }
